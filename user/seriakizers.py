...
class UserRegisterSerializers(serializers.Serializer):
    # 注册序列化。起到校验字段的作用
    u_username = serializers.CharField(required=True,max_length=10,min_length=3,error_messages={'required':'注册账号必填','blank':'注册账号不能为空','max_length':'注册账号不超过10字符','min_length':'注册账号不少于3字符'})
    u_password =serializers.CharField(required=True,max_length=10,min_length=5,error_messages={'required':'注册密码必填','blank':'注册密码不能为空','max_length':'注册密码不超过10字符','min_length':'注册密码不少于5字符'})
    u_password2 =serializers.CharField(required=True,max_length=10,min_length=5,error_messages={'required':'注册确认密码必填','blank':'注册确认密码不能为空','max_length':'注册确认密码不超过10字符','min_length':'注册确认密码不少于5字符'})
...
class UserLoginSerilzers(serializers.Serializer):
    u_username = serializers.CharField(required=True,max_length=10,min_length=3,error_messages={'required':'登录账号必填','blank':'登录账号不能为空','max_length':'登录账号不超过10字符','min_length':'登录账号不少于3字符'})
    u_password =serializers.CharField(required=True,max_length=10,min_length=5,error_messages={'required':'登录密码必填','blank':'登录密码不能为空','max_length':'登录密码不超过10字符','min_length':'登录密码不少于5字符'})
